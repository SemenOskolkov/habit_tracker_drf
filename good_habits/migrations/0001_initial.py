# Generated by Django 4.2 on 2023-04-25 08:27
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_run', models.DateField(blank=True, null=True, verbose_name='Последнее выполнение')),
                ('associated_habit', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='good_habits.habit', verbose_name='Связанная привычка')),
            ],
            options={
